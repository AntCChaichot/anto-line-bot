...
class MainPage(BasePage):
  ...
  def print_main_text(self, cases_info: Tuple[str]) -> str:
    ...
    rv = f"""
Total Cases around the World: {total_cases}
Deaths around the World: {dead_cases}
Recovered Cases around the World: {recovered_cases}
    """
#    print(f'Total Cases around the World: {total_cases}')
#    print(f'Deaths around the World: {dead_cases}')
#    print(f'Recovered Cases around the World: {recovered_cases}')
    return rv   
